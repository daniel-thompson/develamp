...
public:
    ...
    template <class F> static bool make_factory()
    {
    ...
    // this is a ham-fisted way to start us on the road to the NVI design
    // pattern... it seemed like a good idea at the time.
